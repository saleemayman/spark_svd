...
export JAVA_HOME=/home/idax/thirdparty/java-x86_64-71
SPARK_HOME=/home/idax/thirdparty/spark-1.5.0-bin-hadoop2.6
...
$SPARK_HOME/bin/./spark-submit --class test_svd --master spark://konstanz:7077 --deploy-mode client --executor-cores $EXEC_CORES --executor-memory $EXEC_MEM $JAR_FILE $DATA_FILE $DELIMITER $RDD_PARTITIONS 10 > results/$JOB_OUTPUT_FILE.out
